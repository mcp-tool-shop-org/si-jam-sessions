...
La reproducción es determinista: una segunda reproducción produce los mismos bytes. El trabajo de piano de CI
renderizó cada ejemplar entero en Linux, y ambos SHA-256 coinciden con la publicación: lo mismo en Windows y en
Linux. Después de obtener el piano una vez, este comando reproduce la primera:
