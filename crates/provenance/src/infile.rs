...
/// (`licence::restriction_in`, on the text's words: AI wording's short tokens as whole
/// words, every other phrase from the start of a word), which is how a ban on AI use in a
/// text event is read.
